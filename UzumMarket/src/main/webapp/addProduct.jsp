...
<div class="row-container">
    <div class="sidebar">
        <form action="/addCategory.jsp" method="post">
            <button name="product" value="Categories" class="btn btn-primary mb-2 w-100 <%="Categories".equals(request.getParameter("category")) ? "active" : ""%>">Categories</button>
        </form>
        ...
        <form action="/main.jsp" method="post">
            <button class="btn btn-primary w-100">Mainga o'tish</button>
        </form>
    </div>
        ...
        <div class="form-container">
            <form action="/addProd" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="productPhoto" id="productPhoto" class="form-control" accept="image/*" required>
                </div>
